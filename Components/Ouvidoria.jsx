    ...
    <div className='w-full items-center p-10 mb-[80px]'>
      ...
      <div className='mx-[90px] mt-[100]'>
        <Form action="" className='border-3 border-gray-400 p-6 px-[100px] flex flex-col gap-4 rounded-lg items-center'>
            ...
            <input type='email' placeholder='E-mail' className='p-3 border-2 text-wrap border-gray-300 rounded-lg w-full focus:outiline-2 focus:outline-[#fc8a0e]' required/>
            <textarea  placeholder='Descreva o problema'rows={7} className='p-3 border-2 border-gray-300 resize-none  rounded-lg mt-2 pt-7 mb-5 w-full focus:outiline-2 focus:outline-[#fc8a0e]' required/>
