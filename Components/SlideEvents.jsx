  ...
  return (
    <div className="relative w-full py-12 px-4 min-h-screen flex items-center bg-gray-50">
      <div className="max-w-6xl mx-auto w-full justify-center items-center relative">
        {/* Título */}
        <h2 className="text-3xl font-bold text-[#10783b] text-center mb-1">Últimos eventos</h2>
        <div className="w-[150px] bg-[#ffa124] h-1 mx-auto mb-10"></div>

        <div className="relative">
          {/* Botão Esquerdo */}
          <button
            className="swiper-button-prev absolute left-0 top-1/2 transform -translate-y-1 z-10 w-14 h-14 flex items-center justify-center bg-transparent rounded-full shadow-lg transition-colors"
          >           
          ...
          >
            {data.map((item) => (
              <SwiperSlide key={item.id} className="w-full max-w-lg rounded-xl overflow-hidden shadow-2xl">
                ...
                />
                <div className="absolute bottom-0 left-0 w-full h-[170px] bg-gradient-to-t from-black/90 via-black/60 to-transparent z-10 p-3">
          ...
          {/* Botão Direito */}
          <button
            className="swiper-button-next absolute right-0 top-1/2 transform -translate-y-1 z-10 w-14 h-14 flex items-center justify-center bg-transparent rounded-full shadow-lg transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-[#10783b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
