...
const Ouvidoria = () => {
  return (
    <div className='w-full items-center p-10 mb-[80px]'>
      <div className='justify-center items-center p-7 mb-[70px] '>
        <h1 className='text-4xl justify-center text-center font-bold text-[#10783B] mb-5'>Ouvidoria</h1>
         <h3 className='font-bold font[Montserrat] text-3xl mb-2 text-justify ml-[270px]'>O que é ouvidoria?</h3>
         <p className='text-justify font-normal mb-4 text-lg ml-[270px]'>
